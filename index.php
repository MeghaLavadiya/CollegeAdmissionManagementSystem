			...
			<div class="grid grid-column-2 ">
				...
				<div class="column1">
					<div class="heading">
						...
						<p class="my-3 text-white">Welcome to our comprehensive college admission management platform, simplifying the complex process of securing a spot at your dream institution. From streamlining application submissions to providing valuable insights into admission requirements, our user-friendly interface empowers students and educational institutions alike. With a seamless integration of advanced technology and personalized guidance, we aim to foster a transparent and efficient admission journey for all aspiring scholars.</p>
					  </div>
					</div>
					<div class="column2">
